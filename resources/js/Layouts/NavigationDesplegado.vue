...
<template>
    ...
    <div class="overflow-y-auto fixed inset-y-0 left-0 z-30 w-64 bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
        ...
        <nav class="mt-10">
            ...
            <ul class="p-2 mx-4 mt-2 space-y-2 text-sm font-medium text-white bg-gray-700 bg-opacity-50 rounded-md shadow-inner"
                aria-label="submenu">
