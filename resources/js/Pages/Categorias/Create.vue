...
const guardar_tipoServicio = () => {
    ...
    form.post(route('storeCategorias'), {
        onSuccess: (response) => {
        ...
        onError: (errors) => {
            ...
            toast.error('Hubo un error al registrar la tipo de servicio.');
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="text-center w-full mb-4">
                <h1 class="font-semibold mb-5">Tipo de servicio</h1>
            ...
            <div
                ...
                <div class="rounded-t bg-white mb-0 px-6 py-6">
                    <div class="text-center flex justify-center">
                        <h6 class="text-blueGray-700 text-xl font-bold">Agregar tipo de servicio</h6>
                    </div>
                </div>
                <div class="flex-auto px-4 lg:p-3 pt-0">
                    ...
                    <div class="text-center flex justify-center">
                        ...
                        <button @click="guardar_tipoServicio"
